    ...
    with open('static/match_data_analysis.csv') as f:
        ...
        for index, row in df_for_winners.iterrows():
            ...
            if row['team1.win'] == True and champion in team_1_champions_winner:
                ...
                team_1_champions_winner.append(
            ...
            if row['team2.win'] == True and champion in team_2_champions_winner:
                ...
                team_2_champions_winner.append(
        ...
        try:    
            ...
            return JsonResponse({"Error":"No data matched for champion items within your collection","recommended_build":recommended_build})
        ...
        return JsonResponse({"common items":analysis_item_names[:10],"recommended_build":recommended_build})